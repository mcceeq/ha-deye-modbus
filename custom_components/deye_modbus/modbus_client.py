...
class DeyeModbusClient:
    ...
    async def async_read_data(self) -> dict[str, Any]:
        ...
        rr = await self._client.read_holding_registers(70, 17, slave=self._slave_id)
        if not rr.isError():
            b1 = rr.registers
        ...
        rr = await self._client.read_holding_registers(59, 54, slave=self._slave_id)
        if not rr.isError():
            b1b = rr.registers
        ...
        rr = await self._client.read_holding_registers(150, 9, slave=self._slave_id)
        if not rr.isError():
            b2 = rr.registers
        ...
        rr = await self._client.read_holding_registers(160, 13, slave=self._slave_id)
        if not rr.isError():
            b3 = rr.registers
        ...
        rr = await self._client.read_holding_registers(173, 8, slave=self._slave_id)
        if not rr.isError():
            b4 = rr.registers
        ...
        rr = await self._client.read_holding_registers(182, 8, slave=self._slave_id)
        if not rr.isError():
            b5 = rr.registers
        ...
        rr = await self._client.read_holding_registers(190, 5, slave=self._slave_id)
        if not rr.isError():
            b6 = rr.registers
        ...
        rr = await self._client.read_holding_registers(212, 8, slave=self._slave_id)
        if not rr.isError():
            b7 = rr.registers
        ...
        rr = await self._client.read_holding_registers(248, 8, slave=self._slave_id)
        if not rr.isError():
            b8 = rr.registers
        ...
        rr = await self._client.read_holding_registers(256, 6, slave=self._slave_id)
        if not rr.isError():
            b9 = rr.registers
