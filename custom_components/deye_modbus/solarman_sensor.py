"""Dynamic sensors driven by Solarman definitions (read-only)."""
...
async def async_setup_entry(
    ...
    """Set up Solarman-driven sensors if available."""
...
class DeyeSolarmanSensor(CoordinatorEntity, SensorEntity):
    """Sensor entity driven by Solarman definition."""
